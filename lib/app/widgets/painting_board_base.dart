...
abstract class _PaintingBoardBase extends _PaintingBoardBaseCore {
  ...
  void _applyBackendBrushOverride(
    ...
    CanvasBackendFacade.instance.setBrush(
      ...
      bristleEnabled: _brushBristleEnabled,
      bristleDensity: _brushBristleDensity,
      bristleRandom: _brushBristleRandom,
      bristleScale: _brushBristleScale,
      bristleShear: _brushBristleShear,
      bristleThreshold: _brushBristleThreshold,
      bristleConnected: _brushBristleConnected,
      bristleUsePressure: _brushBristleUsePressure,
      bristleAntialias: _brushBristleAntialias,
      bristleUseCompositing: _brushBristleUseCompositing,
      inkAmount: _brushInkAmount,
      inkDepletion: _brushInkDepletion,
      inkUseOpacity: _brushInkUseOpacity,
      inkDepletionEnabled: _brushInkDepletionEnabled,
      inkUseSaturation: _brushInkUseSaturation,
      inkUseWeights: _brushInkUseWeights,
      inkPressureWeight: _brushInkPressureWeight,
      inkBristleLengthWeight: _brushInkBristleLengthWeight,
      inkBristleInkAmountWeight: _brushInkBristleInkAmountWeight,
      inkDepletionWeight: _brushInkDepletionWeight,
      inkUseSoak: _brushInkUseSoak,
